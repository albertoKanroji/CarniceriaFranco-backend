                    ...
                    <table class="table table-bordered table-striped mt-1">
                        <thead class="text-white" style="background: #3B3F5C">
                            <tr>
                                ...
                                <th class="table-th text-center">MINIATURA</th>

                                <th class="table-th text-center">GRUPO MUSCULAR</th>
                                <th class="table-th text-center">VIDEO URL</th>
                                <th class="table-th text-center">ETIQUETAS</th>
                                <th class="table-th text-center">EQUIPOS</th>
